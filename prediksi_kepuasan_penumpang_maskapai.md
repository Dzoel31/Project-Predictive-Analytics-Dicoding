...
Boxplot data latih
![Outlier data train](assets/train_boxplot_outlier.png)

 Boxplot data uji
![Outlier data test](assets/test_boxplot_outlier.png)
...
![Histogram flight distance](assets/histplot_flight_distance.png)
...
![heatmap](assets/heatmap_correlation.png)
...
![rata-rata rating](assets/plot_avg_rating.png)
...
![boxplot_train_setelah_transformasi](assets/train_boxplot_clean.png)

![boxplot_test_setelah_transformasi](assets/test_boxplot_clear.png)
...
![imbalance class](assets/imbalance_class.png)

![balance class](assets/balance_class.png)
...
- Confusion Matrix K-Nearest Neighbors
    ...
    ![Confusion Matrix KNN](assets/cm_knn.png)
...
- Confusion Matrix CatBoost
    ...
    ![Confusion Matrix Catboost](assets/cm_cb.png)
